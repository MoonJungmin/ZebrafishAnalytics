...
{
	mGlobals.CurrentProject->ProjectMake(proj_name_edit->text(), proj_location_edit->text(), background_location_edit->text(), label_location_edit->text(), analytics_location_edit->text());
	qDebug("Accept.");
